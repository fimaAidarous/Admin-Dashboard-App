  ...
  const {currentColor, currentMode } = useStateContext();
   return (
    ...
    <div className='flex flex-wrap lg:flex-nowrap justify-center '>
      <div
        className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full height-auto object-cover lg:w-80 p-8 pt-9 m-3 bg-no-repeat bg-cover bg-center'
      ...
      >
        ...
        items-center'>
          <div>
              ...
              text-1xl'>Earnings</p>
              <p className='text-4xl'>$500,678</p>
          </div>
        </div>
        <div className='mt-6'>
           <Button
